...
Cookie.prototype.initProperties = function() {
  Object.defineProperties(this, { 'params':   { configurable: false, enumerable: false, value: {}, writable: true },
                                  ...
                                  'expires':  { configurable: true, enumerable: true,
                                                get: function() { if(this.params['expires'] != undefined) { return this.params['expires']; } },
                                                set: function(value) {
                                                  if(value instanceof Date) {
                                                    this.params['expires'] = value;
                                                  } else {
                                                    this.params['expires'] = new Date(value);
                                                  }
                                                }
                                              },
                                  'domain':   { configurable: true, enumerable: true,
                                                get: function() { return this.defaultGetter('domain'); },
                                                set: function(value) { this.params['domain'] = String(value).replace(/[^a-z0-9\.\-]/ig, ''); } },
                                  'secure':   { configurable: true, enumerable: true,
                                                get: function() { return (this.params['secure']) ? true : undefined; },
                                  ...
                                  'httponly': { configurable: true, enumerable: true,
                                                get: function() { return (this.params['httponly']) ? true : undefined; },
...
Cookie.prototype.parse = function(cookieString) {
  ...
  if(cookieString != undefined) {
    ...
    options.name = decodeURI(nameValue[0].trim());
    options.value = decodeURI(nameValue[1].trim());
...
Cookie.prototype.toString = function() {
  var cookieString = encodeURI(this.name) + '=' + encodeURI(this.value) + '; ';
